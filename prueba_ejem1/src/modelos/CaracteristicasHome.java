	...
	public List findByExample(Caracteristicas instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("modelos.Caracteristicas")
