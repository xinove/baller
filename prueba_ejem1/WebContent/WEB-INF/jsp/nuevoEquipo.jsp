...
<body>
	...
	<form name="fEquipo"
		action="/prueba_ejem1/baller4ever/insertarEquipo" method="POST">
		<div id="centro1" align="center">
			...
			Nombre del pabellón: <input type="text" name="estadio"><br>
			<input type="hidden" name="idUsuarioFk" value=${equipo.idUsuarioFk}><br>
