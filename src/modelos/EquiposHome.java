 ...
 */
public class EquiposHome {

	private static final Log log = LogFactory.getLog(EquiposHome.class);
	...
	public void persist(Equipos transientInstance) {
	...
	public Equipos merge(Equipos detachedInstance) {
		...
		try {
			Equipos result = (Equipos) sessionFactory.getCurrentSession()
	...
	public Equipos findById(java.lang.Integer id) {
		...
		try {
			Equipos instance = (Equipos) sessionFactory.getCurrentSession()
					.get("modelos.Equipos", id);
			if (instance == null) {
	...
	public List findByExample(Equipos instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("modelos.Equipos")
